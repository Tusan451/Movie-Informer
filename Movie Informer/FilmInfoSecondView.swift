...
struct FilmInfoSecondView: View {
    var film: GenreFilmData? = nil
                    ...
                    VStack(spacing: 24) {
                        VStack(spacing: 16) {
                            FilmInfoHeaderView(
                                ...
                                rating: setRating(),
                                filmTitleRu: film.nameRu ?? film.nameOriginal ?? "",
                                filmTitleEn: film.nameOriginal ?? nil,
...
struct FilmInfoSecondView_Previews: PreviewProvider {
    static var previews: some View {
        FilmInfoSecondView(film: GenreFilmData(
            kinopoiskId: 435,
            nameRu: "Зеленая миля",
...
extension FilmInfoSecondView {
    
    private func loadFilmInfoById() {
        guard let film = film else { return }
        
        guard let url = URL(string: ServerUrlStrings.baseUrl.rawValue + "\(film.kinopoiskId)") else {
            print("Invalid URL")
            return
        }
    ...
    private func loadTrailers() {
        ...
        guard let url = URL(string: ServerUrlStrings.baseUrl.rawValue + "\(film.kinopoiskId)/videos") else {
            print("Invalid URL")
            return
        }
    ...
    private func loadFilmBoxOffice() {
        ...
        guard let url = URL(string: ServerUrlStrings.baseUrl.rawValue + "\(film.kinopoiskId)/box_office") else {
            print("Invalid URL")
            return
        }
    ...
    private func loadFilmTeam() {
        ...
        guard let url = URL(string: "https://kinopoiskapiunofficial.tech/api/v1/staff?filmId=\(film.kinopoiskId)") else {
            print("Invalid URL")
            return
        }
    ...
    private func loadSimilarFilms() {
        ...
        guard let url = URL(string: ServerUrlStrings.baseUrl.rawValue + "\(film.kinopoiskId)/similars") else {
            print("Invalid URL")
            return
        }
    ...
    private func setRating() -> String? {
        ...
        return String(film.ratingKinopoisk)
    }
